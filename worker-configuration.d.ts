/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 845146bf8f134b2083871155b50f6755)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 
interface __BaseEnv_Env {
	CLASS_KV: KVNamespace;
	ASSETS: Fetcher;
	ALLOWED_CIDRS: "";
	PROCESSOR: DurableObjectNamespace<import("./src/worker").LaserContainer>;
	COUNTERS: DurableObjectNamespace<import("./src/worker").Counters>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "LaserContainer" | "Counters";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_CIDRS">> {}
}
